...
description: >-
  ...
  making choices that don't read as templated defaults. Use when redesigning
  pages, polishing UI, or before large visual changes. For phone/tablet layout
  constraints in ParishHub, also apply the responsive-design skill.
